...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"scripts": {
			...
			"docs": "webpack-dev-server --port 8082 --inline --hot --quiet --config webpack.build.js --env docs"
		},
		"keywords": [
			"Bootstrap4",
			"Web",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
		pages: [_srcDocsIntroduction2['default'], _srcDocsToast2['default'], _srcDocsTruncate2['default'], _srcDocsSpinner2['default'], _srcDocsOffcanvasDrawer2['default'], _srcDocsDropdownMultiselect2['default'], _srcDocsButtonToggle2['default']]
	};
	module.exports = exports['default'];
	...
	exports['default'] = {
	  ...
	  data: function data() {
	    return {
	      ...
	      fixed: false,
	      size: 'lg',
	      sizes: _utils.sizes.concat({ text: 'xl', value: 'xl' })
	    };
	  },
	  components: {
